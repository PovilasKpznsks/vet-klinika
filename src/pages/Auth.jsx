...
const Auth = ({ onAuthSuccess }) => {
  ...
  const handleRegister = async (e) => {
    ...
    if (!registerData.personalCode) {
      newErrors.personalCode = 'Asmens kodas yra privalomas'
    } else if (!validatePersonalCode(registerData.personalCode)) {
      newErrors.personalCode = 'Neteisingas asmens kodo formatas'
    }
    ...
    if (!registerData.password) {
      ...
      newErrors.password = 'Slaptažodis turi turėti bent vieną mažą raidę, didžią raidę ir skaičių'
    }
    ...
    try {
      const { confirmPassword, agreeToTerms, agreeToPrivacy, ...userData } = registerData
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      notificationService.addSuccess('Slaptažodžio atkūrimo instrukcijos išsiųstos į jūsų el. paštą')
      setShowForgotPassword(false)
      setForgotPasswordEmail('')
    } catch (error) {
      console.error('Forgot password error:', error)
      notificationService.addError(error.message || 'Klaida siunčiant slaptažodžio atkūrimo instrukcijas')
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="auth-container">
          <div className="auth-card">
            <div className="auth-header">
              ...
              <p>Įveskite savo el. pašto adresą ir mes atsiųsime slaptažodžio atkūrimo instrukcijas</p>
            </div>
          ...
          {isLogin ? (
            ...
            <form onSubmit={handleRegister} className="auth-form">
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label htmlFor="personalCode">Asmens kodas*</label>
                  <input
                    id="personalCode"
                    type="text"
                    value={registerData.personalCode}
                    onChange={(e) => handleRegisterChange('personalCode', e.target.value)}
                    className={errors.personalCode ? 'error' : ''}
                    placeholder="38001010000"
                    disabled={loading}
                  />
                  {errors.personalCode && <span className="error-message">{errors.personalCode}</span>}
                </div>
              </div>
              ...
              <div className="checkbox-group">
                <div className="checkbox-item">
                  ...
                  <label htmlFor="agreeToTerms">
                    Sutinku su <a href="#" target="_blank">naudojimo sąlygomis</a>*
                  </label>
                ...
                <div className="checkbox-item">
                  <input
                    ...
                    onChange={(e) => handleRegisterChange('agreeToPrivacy', e.target.checked)}
                    disabled={loading}
                  />
                  <label htmlFor="agreeToPrivacy">
                    Sutinku su <a href="#" target="_blank">privatumo politika</a>*
                  </label>
