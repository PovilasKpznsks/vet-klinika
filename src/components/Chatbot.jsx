...
const Chatbot = () => {
  ...
  const defaultGreeting = {
    id: 1,
    text: "Sveiki! Aš esu VetKlinika asistentas. Kuo galiu padėti?",
    sender: "bot",
  };
  ...
  useEffect(() => {
    const connection = new signalR.HubConnectionBuilder()
      .withUrl(`${BACKEND_ORIGIN}/chathub`)
  ...
  const sendMessage = async () => {
    ...
    try {
      if (
        ...
        const response = await fetch(`${API_BASE_URL}/Product/chat`, {
          method: "POST",
                        ...
                        img: ({ node, ...props }) => (
                          <img
                            ...
                            onError={(e) => {
                              ...
                              e.target.alt = "Nepavyko įkelti nuotraukos";
                            }}
                          />
                        ),
                      }}
